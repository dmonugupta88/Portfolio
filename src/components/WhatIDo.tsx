        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Crafting clean interfaces, thoughtful user flows, and engaging interactions to build experiences users love.
              </p>
              <h5>Skillset</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">User Journey Mapping</div>
                <div className="what-tags">Responsive Web Design</div>
                <div className="what-tags">Mobile App Design</div>
                <div className="what-tags">Design Systems</div>
                <div className="what-tags">Usability Principles</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Proficient in industry-standard tools to turn ideas into smooth, user-friendly digital experiences.
              </p>
              <h5>Tools</h5>
              <div className="what-content-flex">
